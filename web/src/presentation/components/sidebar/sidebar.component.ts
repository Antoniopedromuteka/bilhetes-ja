...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div class="flex-1 flex flex-col justify-between overflow-y-auto px-3 py-5 space-y-1">
        <ul class="space-y-2">
          <li>
            <a
              routerLink="/"
...
export class SidebarComponent {
  dropdowns = {
    layouts: signal(false),
    crud: signal(false),
    pages: signal(false),
  };

  toggleDropdown(menu: keyof typeof this.dropdowns): void {
    this.dropdowns[menu].set(!this.dropdowns[menu]());
  }
}
